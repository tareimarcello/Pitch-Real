...
public class Registercontroller {
    public void  registra(RegisterBean b){
        ...
        }catch(CredentialException e){                          //Eccezione lanciata nel caso in cui le credenziali sono errate e la uso in questo caso per vedere se ci sono già account registrati con queste credenziali
